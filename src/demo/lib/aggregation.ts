...
import { getInitiative7Summary } from "@demo/features/initiative-7/selectors/summary"
import { getInitiative7GlobalActions } from "@demo/features/initiative-7/selectors/global-actions"
import { getInitiative7AuditEvents } from "@demo/features/initiative-7/selectors/audit-events"
import { getInitiative8Summary } from "@demo/features/initiative-8/selectors/summary"
import { getInitiative8GlobalActions } from "@demo/features/initiative-8/selectors/global-actions"
import { getInitiative8AuditEvents } from "@demo/features/initiative-8/selectors/audit-events"
import { getInitiative13Summary } from "@demo/features/initiative-13/selectors/summary"
import { getInitiative13GlobalActions } from "@demo/features/initiative-13/selectors/global-actions"
import { getInitiative13AuditEvents } from "@demo/features/initiative-13/selectors/audit-events"
import type { AuditEvent, GlobalAction, InitiativeSummary } from "@demo/lib/domain/contracts"
