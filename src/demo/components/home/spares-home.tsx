...
import { AttentionRequiredPanel } from "@demo/components/home/attention-required-panel"
import { InitiativeSummaryCard } from "@demo/components/home/initiative-summary-card"
import { MaterialRiskLandscape } from "@demo/components/home/material-risk-landscape"
import { RecentEventsFeed } from "@demo/components/home/recent-events-feed"
import { RoleSwitcher } from "@demo/components/home/role-switcher"
import { PageHeader } from "@demo/components/shared/page-header"
import {
  getAllAuditEvents,
  getAllGlobalActions,
  getAllInitiativeSummaries,
} from "@demo/lib/aggregation"
import { getPendingApprovals } from "@demo/lib/approvals"
import { sortActionsForRole } from "@demo/lib/home-priority"
import { MATERIALS } from "@demo/lib/shared-data/material-catalog"
import type { SharedRole } from "@demo/lib/shared-data/users"
